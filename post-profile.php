...
$profileid= DB::query('SELECT id FROM users WHERE username=:us', array(':us'=>$user))[0]['id'];
$getposts = DB::query('SELECT * FROM posts WHERE added_by=:user ORDER BY id DESC limit 5 OFFSET '.$row.';', array(':user'=>$profileid));
    ...
    <div class="profile-newfeed">
        ...
        <div class="profile--comments">
            <div class="profile-post-comment">
                <form action="<?php print $_SERVER['MYVAR'];?>home.php?commenti=<?php echo $id;?>" method="POST" class="abc-comment">
