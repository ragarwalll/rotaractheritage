...
?>
<script>
$(".rota-150-logo").css({"display": "none","width":"0px","height":"000vh"});
</script>
...
<a class="export" href="<?php print $_SERVER['MYVAR'];?>fee" style="padding-left: 6px;"><i class="fas fa-sync-alt"></i></a>
<a class="export" href="export-book.php" download><i class="fas fa-external-link-alt"></i></a>
...
<a href="addmembers.php" style="position:fixed;">
    <div class="add_btn">
